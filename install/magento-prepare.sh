...
if [ $1 ] && [ $2 ] && [ $3 ] && [ $4 ];
    then
        ...
        echo "2nd parameter is magento folder name";
        echo "3rd parameter is magento linux user";
        echo "4th parameter is magento linux password";
        echo "Try this: magento-prepare.sh 2.0.7 mywebshop magento magento";
        echo "FAILED";
fi;
